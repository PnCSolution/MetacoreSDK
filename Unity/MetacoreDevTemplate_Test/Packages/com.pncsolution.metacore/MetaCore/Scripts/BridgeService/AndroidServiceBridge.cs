    ...
    public class AndroidServiceBridge : MonoBehaviour
    {
       ...
       *************************************************/
        ...
        *************************************************/
        ...
        private IEnumerator _serviceInit(AidlServiceContext context)
        {
            string serviceType = context.GetServiceType();
        ...
        private IEnumerator _serviceResume(AidlServiceContext context)
        {
            string serviceType = context.GetServiceType();
        ...
        private void _serviceStop(AidlServiceContext context)
        {
            string serviceType = context.GetServiceType();
            string uniqueId = context.GetServiceUniqueId();
        ...
        private void _serviceDestroy(AidlServiceContext context)
        {
        ...
        private void _serviceInvoke(AidlServiceContext context, String _json)
        {
            string serviceType = context.GetServiceType();
            string uniqueId = context.GetServiceUniqueId();
        ...
        public List<float> CallHandOption()
        {
            List<float> result = new List<float>();

            if (_aidlPlugin != null)
            {
                result.Add(_aidlPlugin.Call<float>("getMagnetic"));
                result.Add(_aidlPlugin.Call<float>("getRayDir"));
            }
        ...
        private void OnEventArrived(string jsonParam)
        {
            dispatchEventHandler(jsonParam);
        }

        private void OnCameraArrived(string not)
        {
            eventCameraPreview.Invoke(not);
        }

        private void dispatchEventHandler(string jsonParam)
        {
        ...
        *************************************************/
        ...
        private void OnMsgServiceInit(PncEvent evt)
        {
        ...
        *************************************************/
        ...
        private void OnMsgServiceDestroy(PncEvent evt)
        {
        ...
        *************************************************/
        ...
        private void OnMsgServiceResume(PncEvent evt)
        {
        ...
        *************************************************/
        ...
        private void OnMsgServiceStop(PncEvent evt)
        {
