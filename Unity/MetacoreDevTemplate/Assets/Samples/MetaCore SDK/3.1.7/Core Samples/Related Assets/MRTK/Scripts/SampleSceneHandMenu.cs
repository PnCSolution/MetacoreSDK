...
namespace MixedReality.Toolkit.Examples.Demos
{
    ...
    internal class SampleSceneHandMenu : MonoBehaviour
    {
        ...
        [SerializeField]
        private StatefulInteractable navigationSceneButton;

        [SerializeField]
        private StatefulInteractable stopGameButton;
        ...
        private void Awake()
        {
            ...
            var profiler = FindObjectUtility.FindFirstObjectByType<VisualProfiler>(true);
            if (profiler != null)
            {
            ...
            navigationSceneButton.OnClicked.AddListener(() => GoToNavigationScene());
            stopGameButton.OnClicked.AddListener(() => StopGame());
