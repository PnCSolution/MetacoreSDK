...
namespace MixedReality.Toolkit.UX.Experimental
{
    ...
    public class MetacoreScrollable : MRTKBaseInteractable, IScrollable, IXRHoverInteractableParent, IXRSelectInteractableParent
    {
        /// <summary>
        ...
        private bool UpdateScrolling(out ScrollingInteractorData data)
        {
            ...
            if (contentWidth > 0.0f && scrollRect.horizontal)
            {
            ...
            if (contentHeight > 0.0f && scrollRect.vertical)
            {
